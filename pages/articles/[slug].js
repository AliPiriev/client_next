               ...
               <div className={styles.container}>
                  <div className={styles.top}>
                     ...
                     <div className={styles.info}>
                        {level && (<div className={`${styles.item} lev-item-simple ${level.title.toLowerCase()}`}>{level.title}</div>)}
                    ...
                    <SocialIcons />
                     ...
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M-2.18557e-07 5.5C-2.28619e-07 5.26981 0.0914429 5.04905 0.254213 4.88628L4.38628 0.754214C4.72523 0.415263 5.27477 0.415263 5.61372 0.754214C5.95267 1.09316 5.95267 1.64271 5.61372 1.98166L2.09539 5.5L5.61372 9.01834C5.95268 9.35729 5.95268 9.90684 5.61372 10.2458C5.27477 10.5847 4.72523 10.5847 4.38628 10.2458L0.254213 6.11372C0.091443 5.95095 -2.08495e-07 5.73019 -2.18557e-07 5.5Z" fill="#FF7152"/>
                     <path fill-rule="evenodd" clip-rule="evenodd" d="M0.113281 5.49925C0.113281 5.0199 0.50187 4.63131 0.981219 4.63131L12.438 4.63131C12.9173 4.63131 13.3059 5.0199 13.3059 5.49925C13.3059 5.9786 12.9173 6.36719 12.438 6.36719L0.981219 6.36719C0.50187 6.36719 0.113281 5.9786 0.113281 5.49925Z" fill="#FF7152"/>
                     </svg>
                        Back Topics
                     </div>

                  </div>
                  <div className={`${styles.content} ${styles.textStyles}`}>
                  ...
                  <div className={styles.categories}>
                     <div className='dark-grey-btn'><span>History</span></div>
                     <div className='dark-grey-btn'><span>Mining</span></div>
                     <div className='dark-grey-btn'><span>Trading</span></div>
                     <div className='dot'></div>
                     <div className='dark-grey-btn'><span>Crypto</span></div>
                     <div className='dark-grey-btn'><span>BLOCKchain</span></div>
                  </div>
                  </div>
                  <div className={styles.exploreMore}></div>
               </div>
