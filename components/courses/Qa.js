...
import styles from "../../styles/clientScss/Qa.module.scss";
            ...
            {reviews.map(pObj => (
               <div key={pObj.id} className={styles.reviews}>
                 ...
                 <h5 className={`${styles.starsReview}, ${styles.name}`} key={pObj.id}>{pObj.people}</h5>
                    ...
                    <h5 className={`${styles.stars}, ${styles.reply}`} key={pObj.id}>{pObj.reply}</h5>
                    </button>
                </div>
               ...
               <h3 className={styles.reviewsTitle}>Leave your comment or question</h3>
                <div >
                  <input className="input" type="text" placeholder="Enter text here"></input>
               </div>
