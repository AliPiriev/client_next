...
import Qa from './Qa';
import styles from "../../styles/clientScss/Tabs.module.scss";
        ...
        <div className={styles.contentTabs}>
            ...
            <div className={styles.tabInfo}>
                <div className={styles.mainImg}>
                    <img className="img-absolute" src="/img/tabImg/tabimg.png" alt="lala"></img>
                </div>
                <div className={styles.infoText}>
                    ...
                    <div className={styles.buy}>
                        ...
                        <button className="orange-bg-btn">Buy Course</button>
                    </div>
                </div>
            </div>
            </div>       
