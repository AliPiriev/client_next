...
import styles from "../../styles/instructorScss/VideoContent.module.scss";
// import img1 from "/img/instructorImgs/videoCont.png";
const VideoContent = () => {
    return (
        <div className={styles.VideoContent}>
            ...
            <div className={styles.video}>
                <img className="img-absolute"src="/img/instructorImgs/videoCont.png" />
                <button className={styles.Circle}>
                    <svg className={styles.playBtn} width="140" height="140" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg">
